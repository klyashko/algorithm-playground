package com.algorithm.playground.leetcode.problems.lc600.lc640.lc646
...
class MaximumLengthOfPairChainSpec extends Specification {
    ...
    def "findLongestChain"() {
        ...
        expect:
			...
			new MaximumLengthOfPairChain.Solution().findLongestChain(input as int[][]) == output
    ...
    def "findLongestChainGreedy"() {
        ...
        expect:
			...
			new MaximumLengthOfPairChain.SolutionGreedy().findLongestChain(input as int[][]) == output
