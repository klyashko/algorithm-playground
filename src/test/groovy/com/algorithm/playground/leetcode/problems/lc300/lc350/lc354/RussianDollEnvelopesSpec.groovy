...
import com.algorithm.playground.leetcode.problems.lc300.lc350.lc354.RussianDollEnvelopes.DPSolution as DPS
import com.algorithm.playground.leetcode.problems.lc300.lc350.lc354.RussianDollEnvelopes.Solution as S
import spock.lang.Specification
import spock.lang.Unroll

class RussianDollEnvelopesSpec extends Specification {
	...
	def "maxEnvelopes"() {
		...
		expect:
			...
			new S().maxEnvelopes(envelopes as int[][]) == output

		where:

			envelopes || output
			[[5, 4], [6, 4], [6, 7], [2, 3]] || 3
			[[5, 4], [6, 4], [6, 5], [6, 7], [2, 3]] || 3
	...
	def "maxEnvelopes_dp"() {
		...
		expect:
			...
			new DPS().maxEnvelopes(envelopes as int[][]) == output
