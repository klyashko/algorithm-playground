...
import com.leetcode.problems.dynamicprogramming.medium.MaximumLengthOfPairChain.Solution
import com.leetcode.problems.dynamicprogramming.medium.MaximumLengthOfPairChain.SolutionGreedy
...
class MaximumLengthOfPairChainSpec extends Specification {
    ...
    @Unroll
    def "findLongestChainGreedy"() {

        expect:

            new SolutionGreedy().findLongestChain(input as int[][]) == output
